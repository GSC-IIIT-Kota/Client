            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  const PSectionHeading(title: 'Introduction to Menstrual Health', showActionButton: false,),
                  const SizedBox(
                    height: TSizes.spaceBtwItems,
                  ),
                  PLessonCard(
                  ...
                  PLessonCard(
                    ...
                    onPressed: () => Get.to(() => const PLessonProfile(
                      isVideo: true,
                        videoUrl: "https://youtu.be/cfROFgkV43E?si=s31MoGxEjLclmfxw",
                        lessonTitle: "What does the first period feel like?",
                        lessonCategory:
                            "Menstrual Health and Mental Well-being",
                        lessonAuthor: "Menstrupedia",
                        lessonDescription:
                            "Hey girl! So, when you get your period, it's like your body throwing a little party every month! 🎉 But hey, it's totally normal if you feel a bit funky during this time. Some girls get cramps or feel a bit tired, but don't worry, it's all part of the package. Think of it as your body doing its thing, getting ready for whatever adventures come your way! 💪 And hey, it's not all bad! You might get to rock some cute period undies or try out some fun period products! 🩲 So, embrace the flow, girl! And remember, it's all part of growing up and being awesome! 🌸💖    ")), isVideo: true,
                  ),
                  const SizedBox(
                    height: TSizes.spaceBtwSections,
                  ),
                  const PSectionHeading(title: 'Menstrual Hygiene and Management', showActionButton: false,),
                  const SizedBox(
                    height: TSizes.spaceBtwItems,
                  ),
                  PLessonCard(
                  ...
                  PLessonCard(
                    ...
                    onPressed: () => Get.to(() => const PLessonProfile(
                        isVideo: true,
                        videoUrl: "https://youtu.be/qUNTtn1WPEw?si=YizrRP7MBrNj3dJq",
                        lessonTitle:
                  ...
                  PLessonCard(
                    ...
                    onPressed: () => Get.to(() => const PLessonProfile(
                      isVideo: true,
                        videoUrl: "https://youtu.be/5u6Y6ZP2_Wg?si=ZezvFWoZ-iGr4-_O",
                        lessonTitle: "Cramp 101: Taming Period Pain",
                        lessonCategory:
                            "Menstrual Health and Mental Well-being",
                        lessonAuthor: "Menstrupedia",
                        lessonDescription:
                            "Period cramps are like tiny workouts for your tummy – not the best guests, right? 💔 Fight back with a warm pad on your belly or some pain relievers if needed. 🔥 Drink water to stay hydrated – it's like your secret weapon. 💧 Try easy exercises like stretching or yoga; they're like superhero moves against cramps. 🧘‍♀️ Find a comfy spot, watch your favorite shows, and relax. 📺 Remember, you're the boss of those cramps; they won't stick around forever. 💪🩸")), isVideo: true,
                  ),
                  const SizedBox(
                    height: TSizes.spaceBtwItems,
                  ),
                  PLessonCard(
                    ...
                    onPressed: () => Get.to(() => const PLessonProfile(
                      isVideo: true,
                        videoUrl: "https://youtu.be/gojy9QRRO68?si=0b8ndU1tiGkCzyfv",
                        lessonTitle: "Period Sidekick 101: A Pocket Guide",
                        lessonCategory:
                            "Menstrual Health and Mental Well-being",
                        lessonAuthor: "Menstrupedia",
                        lessonDescription:
                            "Supporting friends during their periods is a breeze! 💨 Step one: stock up on chocolate, the ultimate comfort treat. 🍫 Offer cozy comforts like a heating pad and ace the art of blanket nests. 🛌 Be the distraction guru with jokes or cute videos. 🤣 You're not just a friend; you're the superhero in their period saga! 💪🩸")), isVideo: true,
                  ),
                  const SizedBox(
                    height: TSizes.spaceBtwItems,
                  ),
                  PLessonCard(
                    ...
                    onPressed: () => Get.to(() => const PLessonProfile(
                      isVideo: true,
                        videoUrl: "https://youtu.be/GUVL7jtxTDg?si=ciNR4cGtZ2yJwI0Q",
                        lessonTitle:
                  ...
                  PLessonCard(
                    ...
                    onPressed: () => Get.to(() => const PLessonProfile(
                      isVideo: true,
                        videoUrl: "https://youtu.be/ImzxzlPzbRk?si=UVN8PwgQ6QZTSbQJ",
                        lessonTitle: "First Period Party: Your Quick Guide",
                        lessonCategory:
                            "Impact of Menstrual Health on Daily Life",
                        lessonAuthor: "Menstrupedia",
                        lessonDescription:
                            "Congrats on joining the period club! 🎉 Step one: Don't panic; it's a natural superhero skill. 💪 Check for supplies – pads or tampons – and if you're unsure, a trusted friend or an understanding adult can be your sidekick. 🦸 Embrace comfy vibes with loose clothes and maybe a hot water bottle. 🌡️ Celebrate this rite of passage – you're officially a period pro! 💫🩸")), isVideo: true,
                  ),
                  const SizedBox(
                    height: TSizes.spaceBtwItems,
                  ),
