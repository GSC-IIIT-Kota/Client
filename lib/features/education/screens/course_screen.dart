            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  PSectionHeading(
                    title: translatedStrings?[93] ?? 'Introduction to Menstrual Health',
                  ...
                  PSectionHeading(
                    title: translatedStrings?[103] ?? 'Menstrual Hygiene and Management',
                    showActionButton: false,
                    textColor: dark ? Colors.white : Colors.black,
                  ),
                  const SizedBox(
                  ...
                  PLessonCard(
                    itemNumber: 6,
                    title: translatedStrings?[108] ?? "Stain S.O.S.: Dress Edition",
                    onPressed: () => Get.to(() => PLessonProfile(
                        isVideo: true,
                        videoUrl:
                            "https://youtu.be/i8gYx3ox7K8?si=ZILVWyStlbanopKq",
                        lessonTitle: translatedStrings?[108] ?? "Stain S.O.S.: Dress Edition",
                        lessonCategory: translatedStrings?[6] ?? "Menstrual Hygiene",
                        lessonAuthor: "Menstrupedia",
                        lessonDescription:
                            translatedStrings?[109] ?? "Oops, a period stain? No biggie! Act fast: grab some cold water and gently blot the stain. 💦 If you're a detective with a backpack, a sweater around your waist works wonders. 🧥 Head to the bathroom, use soap and cold water to tackle the stain ninja-style. 🚽 In a pinch? Embrace strategic layering or borrow a friend's emergency hoodie. 👚 Remember, stains happen – you're a stain superhero in the making! 💪🩸")),
                    isVideo: true,
                  ),
                  const SizedBox(
                    height: TSizes.spaceBtwItems,
                  ...
                  PLessonCard(
                    itemNumber: 9,
                    title: translatedStrings?[116] ?? "Decoding PMS: The Monthly Guest",
                    onPressed: () => Get.to(() => PLessonProfile(
                        isArticle: true,
                        lessonThumbnail:
                            "https://www.alpropharmacy.com/wp-content/uploads/2021/05/Femine-01-11-scaled.jpg",
                        lessonTitle: translatedStrings?[116] ?? "Decoding PMS: The Monthly Guest",
                        lessonCategory: translatedStrings?[117] ?? "FAQs and Common Myths",
                        lessonAuthor: "Period Team",
                        lessonDescription:
                            translatedStrings?[118] ?? "PMS stands for Premenstrual Syndrome – a tag-along companion that visits before your period. 🚶‍♀️ It brings a mix of physical and emotional sidekicks, like mood swings, cramps, and bloating. 😩 Think of it as your body's way of giving you a heads-up that the period party is on its way. 🎉 Chocolate cravings, tender feelings, and occasional superhero mood swings may join the parade. 🍫 Don't worry; it's all part of the monthly script. 📜 Treat yourself kindly, maybe with a chocolate bar, and ride the PMS wave like the period pro you are! 🌊🍫🌟")),
                    isVideo: false,
                  ),
                  const SizedBox(
                    height: TSizes.spaceBtwItems,
                  ...
                  PLessonCard(
                    itemNumber: 10,
                    title: translatedStrings?[119] ?? "Can a Girl Get Pregnant as Soon as Her Period Starts?",
                    onPressed: () => Get.to(() => PLessonProfile(
                        isArticle: true,
                        lessonThumbnail:
                            "https://images.agoramedia.com/wte3.0/gcms/nesting-during-pregnancy-722x406.jpg",
                        lessonTitle:
                            translatedStrings?[119] ?? "Can a Girl Get Pregnant as Soon as Her Period Starts?",
                        lessonCategory: translatedStrings?[117] ?? "FAQs and Common Myths",
                        lessonAuthor: "Period Team",
                        lessonDescription:
                            translatedStrings?[120] ?? "Yes, a girl can get pregnant as soon as her period starts. 🤰 A girl can even get pregnant right before her very first period. 🔄 This is because a girl's hormones might already be active. 💫 The hormones may have led to ovulation and the building of the uterine wall. 🏗️ If a girl has sex, she can get pregnant, even though she has never had a period. 🚼")),
                    isVideo: false,
                  ),
                  const SizedBox(
                    height: TSizes.spaceBtwSections,
                  ...
                  PSectionHeading(
                    title: translatedStrings?[121] ?? 'Managing Period Pain and Support',
                    showActionButton: false,
                    textColor: dark ? Colors.white : Colors.black,
                  ),
                  const SizedBox(
                  ...
                  PLessonCard(
                    itemNumber: 12,
                    title: translatedStrings?[124] ?? "Period Sidekick 101: A Pocket Guide",
                    onPressed: () => Get.to(() => PLessonProfile(
                        isVideo: true,
                        videoUrl:
                            "https://youtu.be/gojy9QRRO68?si=0b8ndU1tiGkCzyfv",
                        lessonTitle: translatedStrings?[124] ?? "Period Sidekick 101: A Pocket Guide",
                        lessonCategory:
                            translatedStrings?[101] ?? "Menstrual Health and Mental Well-being",
                        lessonAuthor: "Menstrupedia",
                        lessonDescription:
                            translatedStrings?[125] ?? "Supporting friends during their periods is a breeze! 💨 Step one: stock up on chocolate, the ultimate comfort treat. 🍫 Offer cozy comforts like a heating pad and ace the art of blanket nests. 🛌 Be the distraction guru with jokes or cute videos. 🤣 You're not just a friend; you're the superhero in their period saga! 💪🩸")),
                    isVideo: true,
                  ),
                  const SizedBox(
                    height: TSizes.spaceBtwItems,
